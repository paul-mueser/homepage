<template>
    <div class="personal">
      ...
      <p><router-link to="/projects" class="highlight">Check out my projects</router-link> for more information. If you have any questions or just want to say hi, 
      feel free to contact me via <a class="highlight" href='mailto:kontakt@paulmueser.de'>Mail</a> or using another platform of your choice.</p>
    </div>
</template>
