<template>
  <div class="content">
    ...
    <p>Paul M&uuml;ser<br />
      Dorfstra&szlig;e 16<br />
      59556 Lippstadt</p>
    <p>Telefon: +491757261517<br />
      E-Mail: <a href='mailto:info@paulmueser.de'>info@paulmueser.de</a></p>
    ...
    <p>Wenn das Social-Media-Element aktiv ist, wird eine direkte Verbindung zwischen
      ...
      &uuml;ber den Besuch dieser Website durch Sie.</p>
    <p>Wenn Sie in Ihrem Instagram-Account eingeloggt sind,
    ...
    <p>Die Nutzung dieses Dienstes erfolgt auf Grundlage Ihrer Einwilligung nach Art. 6
      Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TTDSG. Die Einwilligung ist jederzeit widerrufbar.</p>
    <p>Soweit mit Hilfe
      ...
      Canal Harbour, Dublin 2, Irland gemeinsam f&uuml;r diese Datenverarbeitung verantwortlich (Art. 26 DSGVO). Die
      ...
      der Vereinbarung finden Sie unter: <a href="https://www.facebook.com/legal/controller_addendum" target="_blank"
        rel="noopener noreferrer">https://www.facebook.com/legal/controller_addendum</a>. Laut
      ...
      geltend machen, sind wir verpflichtet, diese an Facebook weiterzuleiten.</p>
    <p>Die Daten&uuml;bertragung in die
